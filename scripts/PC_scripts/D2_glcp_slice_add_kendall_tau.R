...
pacman::p_load(vroom, dplyr, tidyr, Kendall, readr)

#### Bringing in 'glcp slim' data set ####
d <- vroom::vroom("./output/D1_glcp_yearly_slice.csv")
...
#export
  write_csv(., file = paste0("./output/D2_glcp_slice_added_kendall_tau.csv"))
