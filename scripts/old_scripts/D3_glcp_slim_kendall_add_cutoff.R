...
pacman::p_load(vroom, dplyr, tidyr, Kendall, readr, broom)

#### Bringing in the data set ####

d <- vroom::vroom("./outputs/PC2_calc_kendall_tau_stat.csv")
...
#export
  write_csv(., file = paste0("./outputs/PC3_calc_cutoff_ratio.csv"))
