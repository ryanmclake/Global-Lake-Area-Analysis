...
file <-  list.files(path = "C:/Users/mcclurer/OneDrive - National Ecological Observatory Network/Documents/R/Global-Lake-Area-Analysis/inputs/countries")
  #imports using 'vroom' 
...
d <- vroom::vroom(paste0("C:/Users/mcclurer/OneDrive - National Ecological Observatory Network/Documents/R/Global-Lake-Area-Analysis/inputs/countries/", file), col_names = F) 

m <- vroom::vroom("C:/Users/mcclurer/OneDrive - National Ecological Observatory Network/Documents/R/Global-Lake-Area-Analysis/inputs/matches/basin_matches.csv") |>
  rename(X1 = HYBAS_ID)
...
d %>%
    ...
    slice(1) %>%
    #BE SURE TO UPDATE YOUR PATH
    write.table(., file = paste0("C:/Users/mcclurer/OneDrive - National Ecological Observatory Network/Documents/R/Global-Lake-Area-Analysis/D1_glcp_yearly_slice.csv"),
              append = T,
              row.names = F,
              col.names = !file.exists("C:/Users/mcclurer/OneDrive - National Ecological Observatory Network/Documents/R/Global-Lake-Area-Analysis/D1_glcp_yearly_slice.csv"))
